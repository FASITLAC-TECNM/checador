        ...
        <div className="p-6">
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  value={diasTotales}
                  disabled
                  className="w-full px-4 py-2 bg-bg-secondary border border-border-subtle rounded-lg text-text-secondary text-center font-bold text-xl cursor-not-allowed"
                />
              </div>
            </div>
          </div>
          ...
          <div className="mb-6">
            ...
            <textarea
              ...
              rows={4}
              className="w-full px-4 py-3 bg-bg-primary border border-border-subtle rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent resize-none text-text-primary placeholder:text-text-disabled"
            />
          </div>
