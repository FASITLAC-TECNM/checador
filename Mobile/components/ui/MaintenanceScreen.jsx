...
const MaintenanceScreen = ({ onRetry, darkMode = false }) => {
    ...
    // Animación de giro cuando está revisando
    useEffect(() => {
        if (isRetrying) {
            Animated.loop(
    ...
    return (
        <View style={[styles.container, { backgroundColor: colors.bg }]}>
            ...
            <Animated.View style={[
                ...
                {/* Franja ámbar superior */}
                <View style={styles.topBar} />

                {/* Franjas diagonales decorativas de fondo */}
...
const styles = StyleSheet.create({
    ...
    // Barra ámbar fija en la parte superior (4px)
    topBar: {
        height: 4,
        backgroundColor: '#f59e0b',
        width: '100%',
    },
    // Franjas diagonales decorativas (solo en el área del topBar)
    stripesContainer: {
        height: 52,
        width: '100%',
        flexDirection: 'row',
    ...
    stripe: {
        ...
        width: 12,
        height: 120,
        backgroundColor: 'rgba(245,158,11,0.07)', // fallback, sobreescrito inline
